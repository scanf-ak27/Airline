...
public class Mainframe extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1920, 1200); 
	add(NewLabel); 
        
        JLabel AirlineManagementSystem = new JLabel("Welcome To Our Airlines.");
	AirlineManagementSystem.setForeground(Color.BLACK);
        AirlineManagementSystem.setFont(new Font("Italic", Font.ITALIC,50));
	AirlineManagementSystem.setBounds(10, 10, 40, 55);
	...
	menuBar.add(Ticket);
        ...
        JMenuItem Ticket_info = new JMenuItem("INFORMATION");
	Ticket.add(Ticket_info);
